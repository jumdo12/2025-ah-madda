...
public class Event extends BaseEntity {
    ...
    public boolean hasQuestion(final Question question) {
        return getActiveApplicationFormVersion().hasQuestion(question);
    }

    public Set<Question> getRequiredQuestions() {
        return getActiveApplicationFormVersion().getRequiredQuestions();
    }

    public List<Question> getQuestions() {
        return getActiveApplicationFormVersion().getQuestions();
    }

    public ApplicationFormVersion getActiveApplicationFormVersion() {
        return applicationForm.getActiveVersion();
    }

    public ApplicationFormVersion reviseApplicationForm(
            final Member organizer,
            final List<Question> questions
    ) {
        validateUpdatableBy(organizer);
